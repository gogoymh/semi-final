...
from additive_decomp_var2 import Unet as net
from additive_decomp_var2 import HM70A, miniSONO, wrist, forearm, task
...
main_path = ["/data/ymh/US_segmentation/",
             "/DATA/ymh_ksw/dataset/US_image/"]

main_num = 1

path1s = [main_path[main_num] + "newset/wrist_train/wrist_HM70A",
          main_path[main_num] + "newset/forearm_train/forearm_HM70A",
          main_path[main_num] + "newset/wrist_train/wrist_miniSONO",
          main_path[main_num] + "newset/forearm_train/forearm_miniSONO"]

path2s = [main_path[main_num] + "newset/wrist_target/wrist_HM70A",
          main_path[main_num] + "newset/forearm_target/forearm_HM70A",
          main_path[main_num] + "newset/wrist_target/wrist_miniSONO",
          main_path[main_num] + "newset/forearm_target/forearm_miniSONO"]
...
lambdas = torch.zeros(4) # [1/4,1/4,1/4,1/4]
